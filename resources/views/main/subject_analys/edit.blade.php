        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" action="/subjectanalys/{{$subjectanalys->id}}" method="post" >
                {{-- <form class="form-horizontal" role="form" action="/muser" method="post"> --}}
                  ...
                  @endif
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="subject_name" required="required" value="{{$subjectanalys->name}}">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="control-label col-sm-2" >ราคา:</label>
                            <div class="col-sm-10">
                            <input type="number" class="form-control" name="subject_price" required="required" min="1" value="{{$subjectanalys->price}}">
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-3 col-md-offset-2">
                              <button type="submit" class="btn btn-primary">
                                <span class='glyphicon glyphicon glyphicon-ok'></span> Update
                              </button>
