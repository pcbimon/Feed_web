  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">การจัดการผู้ใช้บริการ</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">การจัดการผู้ใช้บริการ</h3>
                ...
                <tbody>
                  ...
                  @foreach($customers as $item)
                    ...
                    <td><img src= {{ URL::asset($item->path_pic) }} width="100px" height="100px"></td>
          					<td><button class="btn btn-info" onclick="window.location='{{ url("customer/$item->id/edit") }}'">
