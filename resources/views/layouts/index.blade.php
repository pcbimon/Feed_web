...
<head>
  ...
  <title>การให้บริการการวิเคราะห์อาหารสัตว์ | @yield('title')</title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>LTE {{\Auth::user()->type_user_id}}</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src= {{ URL::asset(\Auth::user()->path_pic) }} class="user-image" alt="User Image">
